...
export const paymentGatewayCodeSchema = z.enum([
  "CREDIMAX",
  "BENEFIT",
  "STRIPE",
]);
...
export const generatedMediaStatusSchema = z.enum([
  "PENDING_REVIEW",
  "APPROVED",
  "REJECTED",
]);
...
export const vaultWebsiteIngestJobCreateSchema =
  vaultWebsiteIngestPreviewSchema.extend({
...
export const vaultWebsiteIngestApproveSchema = z.object({
  candidates: z
    .array(vaultWebsiteIngestCandidateSchema)
    .min(1)
    .max(20)
    .optional(),
  writeMode: z.enum(["MERGE", "OVERWRITE"]).default("MERGE"),
});
...
export const vaultWebsiteIngestJobParamsSchema = z.object({
  jobId: z.string().uuid(),
});
...
const nonEmptyStringArraySchema = z
  ...
  .min(1)
  .max(30);
const optionalCatalogStringArraySchema = z
...
export const campaignBriefSchema = z.object({
  ...
  contentTypes: z
    ...
    .min(1)
    .max(4)
    .default(["POST", "CAROUSEL", "REEL", "STORY"]),
...
export const campaignPackageSchema = z
  ...
  .superRefine((value, context) => {
    ...
    const scheduleIds = new Set(
      value.schedule.map((item) => item.contentItemId),
    );
...
export type VaultWebsiteIngestApproveInput = z.infer<
  typeof vaultWebsiteIngestApproveSchema
>;
export type VaultWebsiteIngestCandidateInput = z.infer<
  typeof vaultWebsiteIngestCandidateSchema
>;
export type VaultWebsiteIngestJobCreateInput = z.infer<
  typeof vaultWebsiteIngestJobCreateSchema
>;
export type VaultWebsiteIngestPreviewInput = z.infer<
  typeof vaultWebsiteIngestPreviewSchema
>;
export type VaultWebsiteIngestRejectInput = z.infer<
  typeof vaultWebsiteIngestRejectSchema
>;
...
export type GenerateContentForSlotInput = z.infer<
  typeof generateContentForSlotSchema
>;
...
export type GenerateCampaignPackageInput = z.infer<
  typeof generateCampaignPackageSchema
>;
export type CampaignPackageListQueryInput = z.infer<
  typeof campaignPackageListQuerySchema
>;
export type RejectCampaignItemInput = z.infer<typeof rejectCampaignItemSchema>;
export type ScheduleCampaignPackageInput = z.infer<
  typeof scheduleCampaignPackageSchema
>;
export type BrandBookExportListQueryInput = z.infer<
  typeof brandBookExportListQuerySchema
>;
export type CatalogProductListQueryInput = z.infer<
  typeof catalogProductListQuerySchema
>;
export type CatalogOfferListQueryInput = z.infer<
  typeof catalogOfferListQuerySchema
>;
export type CreateCatalogProductInput = z.infer<
  typeof createCatalogProductSchema
>;
export type UpdateCatalogProductInput = z.infer<
  typeof updateCatalogProductSchema
>;
...
export type AnalyticsMonthlyPdfInput = z.infer<
  typeof analyticsMonthlyPdfSchema
>;
export type AnalyticsMonthlyEmailInput = z.infer<
  typeof analyticsMonthlyEmailSchema
>;
...
export type BillingPaymentCaptureParamsInput = z.infer<
  typeof billingPaymentCaptureParamsSchema
>;
export type AdminUpdatePlanLimitsInput = z.infer<
  typeof adminUpdatePlanLimitsSchema
>;
export type AdminModelSettingKeyInput = z.infer<
  typeof adminModelSettingKeySchema
>;
export type AdminUpdateModelSettingInput = z.infer<
  typeof adminUpdateModelSettingSchema
>;
...
>;
export type SelectPromptVariantInput = z.infer<
  typeof selectPromptVariantSchema
>;
export type UpdateContentInput = z.infer<typeof updateContentSchema>;
export type UpdateContentStatusInput = z.infer<
  typeof updateContentStatusSchema
>;
...
export type RegisterPublicMediaInput = z.infer<
  typeof registerPublicMediaSchema
>;
export type UploadMediaInput = z.infer<typeof uploadMediaSchema>;
export type AttachMediaToContentInput = z.infer<
  typeof attachMediaToContentSchema
>;
export type GenerateImageForContentInput = z.infer<
  typeof generateImageForContentSchema
>;
export type VisualStudioGenerateInput = z.infer<
  typeof visualStudioGenerateSchema
>;
...
>;
export type AttachGeneratedMediaVariantInput = z.infer<
  typeof attachGeneratedMediaVariantSchema
>;
