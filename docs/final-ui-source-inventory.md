...
- Existing `ContentCalendar`, `PublishingQueue`, `Analytics`, `KnowledgeVault`, `Strategy`, and `AIConsultant` should be re-skinned carefully, not blindly copied, because our repo already has working backend-aware versions.
