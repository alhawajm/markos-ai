...
| Instagram token refresh and disconnect                                                           | **Implemented and locally/CI verified**                          | Manual and worker refresh paths, expiration handling, best-effort provider permission removal, guaranteed local disconnect with a manual fallback, and callback handling exist. A full production token lifetime and provider-side revocation/deauthorization delivery have not been verified. |
