...
| MFA and bearer-token lifecycle                                                                   | **Implemented foundations; journey hardening planned**           | TOTP, access/refresh issuance, refresh rotation, and reuse detection have tests. Current UI completion and production lifecycle quirks remain roadmap work.                                                                              |
...
3. Resolve bearer-token expiry and lifecycle quirks across the real UI journey.
