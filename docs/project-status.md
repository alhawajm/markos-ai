...
| Instagram token refresh and disconnect                                                           | **Implemented and locally/CI verified**                          | Manual and worker refresh paths, expiration handling, disconnect, and callback handling exist. A full production token lifetime and provider-side revocation/deauthorization delivery have not been verified.                            |
