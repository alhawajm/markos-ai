...
8. Complete controlled live Instagram publish verification.
9. Complete controlled live Instagram analytics verification.
10. Complete CrediMax or BENEFIT live payment verification.
11. Run the launch smoke test from `docs/launch-runbook.md`.
12. Update `docs/milestone-checklist.md` only after every external blocker is closed.
