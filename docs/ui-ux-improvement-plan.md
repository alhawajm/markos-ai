...
**Historical review artifact:** the standalone shared-foundation comparison was removed during handoff cleanup. Use the implemented application and current design decisions for review.
...
**Historical prototype checkpoint — 2026-08-27 (artifact removed during handoff cleanup)**

- The retired Create workflow prototype connected Action hub, Untouched, Unsaved changes, Saved draft, Ready, scheduling review, and Scheduled states in one browser-rendered artifact. It performs no API calls or workspace writes and visibly labels its sample content as prototype data.
